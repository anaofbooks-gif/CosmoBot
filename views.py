...
from ai import obter_info_livro, extrair_texto_da_imagem, validar_resposta_ia_pydantic, validar_resposta_ia, ai_json_com_retry, validar_livro_existe
...
class ViewConfirmarLido(discord.ui.View):
    ...
    async def detetar_serie_pos_lido(self):
        ...
        from ai import validar_livro_existe, ai_json_com_retry
